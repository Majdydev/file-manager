...
function requireBindings() {
  ...
  (function(module, exports) {
    var fs2 = require$$0$1, path2 = require$$1, fileURLToPath = requireFileUriToPath(), join = path2.join, dirname = path2.dirname, exists = fs2.accessSync && function(path22) {
      try {
